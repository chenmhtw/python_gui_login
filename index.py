...
screen_width = int((screen_width - width) / 2)
screen_height = int((screen_height - height) / 2)
...
def home_handler(event):
    label_welcome.place_forget()
    label_slogan.place_forget()
...
def weather_handler(event):
    pass

def death_handler(event):
    pass

def members_handler(event):
    pass
...
line.place(x=48, y=60)


label_welcome = customtkinter.CTkLabel(
    master=main,
    text="Welcome To The GUI Project",
    text_color="BLACK",
    font=("time news romen", 28, "bold"),
    bg_color="#F6F1F1"
)
label_welcome.place(x=52,y=200)

label_slogan = customtkinter.CTkLabel(
    master=main,
    text="Just do it.",
    text_color="BLACK",
...
label_slogan.place(x=52,y=250)

label_home = customtkinter.CTkLabel(
    master=main,
    text="HOME",
    text_color="BLACK",
...
label_home.bind("<Button-1>", home_handler)
label_home.place(x=52,y=20)

label_weather = customtkinter.CTkLabel(
    master=main,
    text="WEATHER",
    text_color="BLACK",
    font=("time news romen", 15, "bold"),
...
label_weather.bind("<Button-1>", weather_handler)
label_weather.place(x=140,y=20)

label_death = customtkinter.CTkLabel(
    master=main,
    text="DEATH",
    text_color="BLACK",
    font=("time news romen", 15, "bold"),
...
label_death.bind("<Button-1>", death_handler)
label_death.place(x=260,y=20)

label_members = customtkinter.CTkLabel(
    master=main,
    text="MEMBERS",
    text_color="BLACK",
    font=("time news romen", 15, "bold"),
...
label_members.bind("<Button-1>", members_handler)
label_members.place(x=768,y=20)
